...
export const POI_CATALOG: PoiSeedData[] = [
  ...
  descriptionHistory:
    '«День поля» — это крупное агропромышленное мероприятие, на котором демонстрируют современную сельскохозяйственную технику, новые технологии, достижения селекции и успешные практики в растениеводстве.',
  interestingFacts: [
