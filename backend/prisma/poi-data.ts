...
export const POI_CATALOG: PoiSeedData[] = [
  ...
  descriptionHistory:
    '«День поля» — это крупное агропромышленное мероприятие, на котором демонстрируют современную сельскохозяйственную технику, новые технологии, достижения селекции и успешные практики в растениеводстве. Здесь встречаются фермеры, специалисты агропромышленного комплекса, студенты и все, кто интересуется сельским хозяйством.',
  interestingFacts: [
    'На мероприятии можно увидеть работу современной сельскохозяйственной техники прямо в поле.',
    'Участники знакомятся с новыми сортами сельскохозяйственных культур и технологиями их выращивания.',
    '«День поля» ежегодно собирает представителей аграрной отрасли со всего региона.',
  ],
  bestSeason: ['summer'],
  difficulty: 'easy',
  baseXp: 500,
